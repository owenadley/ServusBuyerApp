...
class MyServices extends Component {
  ...
  servicePreviewList() {
    if (this.state.serviceExists) {
      ...
      return (
        <View>
          <Text style={st.heading2}>You have no active services</Text>
        </View>
      );
    }
  }
  ...
  render() {
    ...
    if (this.state.sellerName !== null) {
      return (
        ...
        >
          <View style={{ alignItems: "center" }}>
            ...
            <TouchableOpacity style={st.btn} onPress={this.sellAService.bind()}>
      ...
      if (this.props.navigation.getParam("sellerName")) {
        this.fetchData();
      }
      return (
        <View
